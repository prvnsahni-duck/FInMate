...
/**
 * Greedy debt-simplification over an opaque balance-graph key. Shared by
 * SettlementsService (suggested settlements) and ExpensesService (Carry
 * Forward month-close rollover) so both stay identical in rounding,
 * ordering, and tie-breaking. See docs/audits/expense-architecture-audit.md
 * (P1-3) for why this was extracted.
 */
