...
then reclaim vertical space (1.2), _then_ — only after the form is lean — tackle
...
"Customize Split" sheet for mode + amounts. Participant selection exists in _two_
...
mode control (Phase 1 scope). This yields the leanest default form _and_ the
