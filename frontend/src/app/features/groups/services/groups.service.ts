...
export class GroupsService {
  ...
  getMembers(groupId: string): Observable<GroupMember[]> {
    return this.http.get<GroupMember[]>(`${this.baseUrl}/groups/${groupId}/members`);
  }
  ...
  getBalances(groupId: string): Observable<GroupBalancesResponse> {
    return this.http.get<GroupBalancesResponse>(`${this.baseUrl}/groups/${groupId}/settlements/balances`);
  }
  ...
  getHistoryLogs(groupId: string): Observable<GroupAuditLogResponse> {
    return this.http.get<GroupAuditLogResponse>(`${this.baseUrl}/groups/${groupId}/history`);
  }
  ...
  getDeletedExpenses(groupId: string): Observable<{ data: Expense[] }> {
    return this.http.get<{ data: Expense[] }>(`${this.baseUrl}/groups/${groupId}/expenses/deleted`);
  }
  ...
  getCarryForward(groupId: string, month: string): Observable<CarryForwardBalance[]> {
    return this.http.get<CarryForwardBalance[]>(`${this.baseUrl}/groups/${groupId}/carry-forward?month=${month}`);
  }
  ...
  updateGroup(groupId: string, groupData: UpdateGroupDto): Observable<Group> {
    return this.http.patch<Group>(`${this.baseUrl}/groups/${groupId}`, groupData);
  }
  ...
  regenerateInviteToken(groupId: string): Observable<Group> {
    return this.http.post<Group>(`${this.baseUrl}/groups/${groupId}/invite-link/regenerate`, {});
  }
  ...
  joinGroup(inviteToken: string): Observable<GroupMember> {
    return this.http.post<GroupMember>(`${this.baseUrl}/groups/join/${inviteToken}`, {});
  }
  ...
  getInviteDetails(inviteToken: string): Observable<InviteDetailsResponse> {
    return this.http.get<InviteDetailsResponse>(`${this.baseUrl}/invite-links/${inviteToken}`);
  }
  ...
  getContributions(groupId: string, month: string): Observable<GroupContributionResponse[]> {
    return this.http.get<GroupContributionResponse[]>(`${this.baseUrl}/groups/${groupId}/contributions?month=${month}`);
  }
  ...
  updateContributions(groupId: string, payload: UpdateContributionDto | UpdateContributionsPayload): Observable<GroupContributionResponse[]> {
    return this.http.post<GroupContributionResponse[]>(`${this.baseUrl}/groups/${groupId}/contributions`, payload);
  }
  ...
  inviteMember(groupId: string, payload: { email?: string; identifier?: string; role?: string; displayName?: string }): Observable<GroupMember> {
    return this.http.post<GroupMember>(`${this.baseUrl}/groups/${groupId}/members`, payload);
  }
  ...
  updateMember(groupId: string, memberId: string, payload: { role?: string; joinStatus?: string }): Observable<GroupMember> {
    return this.http.patch<GroupMember>(`${this.baseUrl}/groups/${groupId}/members/${memberId}`, payload);
  }
  ...
  removeMember(groupId: string, memberId: string): Observable<void> {
    return this.http.delete<void>(`${this.baseUrl}/groups/${groupId}/members/${memberId}`);
  }
